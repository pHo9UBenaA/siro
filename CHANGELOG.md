...
- Require an explicit declaration and matching policy when a new package manager is added; require a root/member decision for every built-in rule. Existing six-manager behavior and the three member publication checks retain their scope and ordering.

...
import type { WorkspaceGlob } from '../contracts/workspace-glob.ts';
import type { WorkspaceDefinition } from './declarations.ts';
import { anchorWorkspacePrefix } from './prefix.ts';
import { workspaceGlobOptions } from './glob-policy.ts';
import { compileAdditionalWorkspaceGlob } from './dialects.ts';
import { hasBasicWorkspaceWildcard, stripTrailingWorkspaceSlashes } from './pattern.ts';

...
| deno | `minimumDependencyAge` (deno.json)        | TBD (introduced in Deno 2.x) ([docs](https://docs.deno.com/runtime/reference/deno_json/))                                       | **deno 2.9.0** (1440 minutes) ([release](https://github.com/denoland/deno/releases/tag/v2.9.0))                                                                             | ISO-8601 duration, date, timestamp, minutes number, or object with optional `age`. |
